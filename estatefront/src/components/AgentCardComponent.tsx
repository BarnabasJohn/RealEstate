...
const AgentCardComponent = ({ listing }: ListingProps) => {
  let url = listing.visual_urls[0]

  const agentId = localStorage.getItem('agentId');

  return (
    <div className="bg-gray-200 shadow-lg rounded-lg p-2 m-1 hover:bg-blue-300 border-2 border-black">
      <Link href={`/agent/${agentId}/listings/${listing.id}`}>
